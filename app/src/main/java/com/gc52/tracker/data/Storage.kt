...
object PlatformIcons {
    private val map = mapOf(
        ...
        // console-render pack additions
        "Commodore Amiga" to "commodore-amiga",
        "Nintendo Switch" to "nintendo-switch",
        "PC" to "pc",
        "ZX Spectrum" to "zx-spectrum",
        "Sinclair ZX Spectrum" to "zx-spectrum",
        "X68000" to "x68000",
        "Sharp X68000" to "sharp-x68000",
        "Nintendo 3DS" to "nintendo-3ds",
        "Nintendo DS" to "nintendo-ds",
        "Sony PlayStation Vita" to "sony-playstation-vita",
        "Sony PlayStation 3" to "sony-playstation-3",
        "Sony PlayStation 4" to "sony-playstation-4",
        "Arcade" to "arcade",
        "DOS" to "dos",
        "MS-DOS" to "dos",
        "ScummVM" to "scummvm",
        "Nintendo WiiU" to "nintendo-wiiu",
        "Nintendo Wii U" to "nintendo-wiiu",
        "Nintendo WiiWare" to "nintendo-wiiware",
        "Android" to "android",
        "Xbox 360" to "xbox-360",
        "Microsoft Xbox 360" to "xbox-360",
        "Xbox" to "xbox",
        "PC Engine CD" to "pc-engine-cd",
        "Nintendo Famicom Disk System" to "nintendo-famicom-disk-system",
        "Famicom Disk System" to "nintendo-famicom-disk-system",
        "MSX" to "msx",
        "WonderSwan" to "wonderswan",
        "Panasonic 3DO" to "panasonic-3do",
